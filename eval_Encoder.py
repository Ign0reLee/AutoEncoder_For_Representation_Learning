...
parser.add_argument("--name", "-n", default="encoder", type=str, dest="result_dir")

args = parser.parse_args()

batch_size    = args.batch_size
data_dir      = args.data_dir
ckpt_dir      = os.path.join(args.ckpt_dir, "Encoder")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        model.eval()
        vector_sum = torch.zeros((1, 32 * 32, 20, 15)) # latent vector size
